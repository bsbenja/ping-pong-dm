...
```{r}
#| output: asis
cat("![](filer/generelt/wcpp-finale-2019.png){width=40em}<br><figcaption><i style=font-size:80%>Billede fra WCPP-finalen 2019</i></figcaption><p><p>")
```
...
1.  **ALLE kan deltage**`r "^[<b>ALLE kan deltage</b>: Da turneringen er et dansk mesterskab, skal man enten være (1) dansk statsborger eller (2) have boet i Danmark i minimum de seneste fem år (skal kunne dokumenteres af spilleren). Er dette ikke opfyldt, vil det være muligt at deltage udelukkende i puljespillet, hvor ens resultater ikke tæller med i puljeregnskabet (tilmelding stadig påkrævet).]"`: Der er ingen adgangsbarriere, dvs. ALLE har mulighed for at stille op uanset alder, køn, niveau eller licens. Man behøver derfor ikke nødvendigvis at have haft erfaring med bordtennis/Ping Pong tidligere.
...
1.  Nr. 1-4 seedes efter placeringerne i "Final 4" i A-slutspil ved sidst afholdte DM`r "^[<b>Resultater sidste DM</b>: Ved sidste DM i 2023 i Hørning var <q>Final 4</q> deltagerne:<br>Nr. 1. Benjamin Sørensen, Hørning BTK.<br>Nr. 2. Emil Madsen, Hørning.<br>Nr. 3. Bjarke Krog, B75.<br>Nr. 4. Mads Larsen, Silkeborg BTK.]"`.
...
flowchart TD
  ...
  style E fill:#1C2833,stroke:#1C2833,color:#FFFFFF
```
...
```{r}
#| output: asis
cat(DataEventAarAkt_T$InfoTipVM_DW)
```
:::
...
kbl_webscraping_DM_resultater <- tbl_webscraping_DM_resultater %>%
  ...
  footnote(
    "Webscraped fra BTDK's hjemmeside
    <a href=https://bordtennisdanmark.dk/statistik/ping-pong-dm target=_blank><b>HER</b></a>",
...
DataResultAlle_T %>%
  ...
  kable_styling(position = "l", full_width = F, htmltable_class = "table-condensed") %>%
  row_spec(0, background = "#1C2833", color = "#FFFFFF") %>%
  row_spec(which(grepl("Aflyst", DataResultAlle_T$Navn)),
           strikeout = T, italic = T, color = "#5D6D7E") %>%
  remove_column(c(2, 5:9)) %>%
  footnote(
    "Webscraped fra BTDK's hjemmeside
    <a href=https://bordtennisdanmark.dk/statistik/ping-pong-dm target=_blank><b>HER</b></a>",
    general_title = "", escape = F)
...
-   `r "[Video fra Ping Pong DM <b>2022</b>: <q>Final 4</q>](https://youtu.be/2LF1PVgdM-w){target=_blank}"`
-   `r "[Video fra Ping Pong DM <b>2022</b>: Preliminary matches + Playoffs](https://youtu.be/i7NUmq1R6VY){target=_blank}"`
-   `r "[Video fra Ping Pong DM <b>2021</b>: 9 min. sammenklip af finalekampen i <q>Final 4</q>](https://www.facebook.com/{{< var var.facebook_side_id >}}/videos/672876054123143){target=_blank}"`
-   `r "[Video fra Ping Pong DM <b>2018</b>: Finale](https://www.facebook.com/{{< var var.facebook_side_id >}}/videos/2533896386870286){target=_blank}"`
-   `r "[Video fra Ping Pong DM <b>2018</b>: Semifinale (2)](https://www.facebook.com/{{< var var.facebook_side_id >}}/videos/259264551753924){target=_blank}"`
-   `r "[Video fra Ping Pong DM <b>2018</b>: Seminfale (1), sæt 2 af 2](https://www.facebook.com/{{< var var.facebook_side_id >}}/videos/303186807322141){target=_blank}"`
-   `r "[Video fra Ping Pong DM <b>2018</b>: Seminfale (1), sæt 1 af 2](https://www.facebook.com/{{< var var.facebook_side_id >}}/videos/1569763316525030){target=_blank}"`
-   `r "[Video fra Ping Pong DM <b>2017</b>: Del 2 af 2](https://www.facebook.com/{{< var var.facebook_side_id >}}/videos/208760437117940){target=_blank}"`
-   `r "[Video fra Ping Pong DM <b>2016</b>: Finale og bronzekamp](https://www.facebook.com/{{< var var.facebook_side_id >}}/videos/144520200285594){target=_blank}"`
-   `r "[Video fra Ping Pong DM <b>2016</b>: Semifinaler](https://www.facebook.com/{{< var var.facebook_side_id >}}/videos/3001276553228375){target=_blank}"`
-   `r "[Video fra Ping Pong DM <b>2016</b>: Kvartfinaler](https://www.facebook.com/{{< var var.facebook_side_id >}}/videos/512649046032364){target=_blank}"`