...
DataResultSandpapirAabenSingle_T <- DataResult_T %>% filter(
  (grepl("A-slutspil", DeltSlutspil_RD) &
  grepl("1", DeltPlacNr_RD) &
  grepl("Sandpapir", BilletDisciplin_RD) &
  grepl("Åben", BilletRaekke_RD) &
  grepl("Single", BilletSpilFormat_RD)) |
