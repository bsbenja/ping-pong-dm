...
DataAkt_T <- Analyse_Ordre %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD))
DataEventAarAkt_T <- DataEventAar_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD))
DataEventAarSidst_T <- DataEventAar_T %>% filter(
  grepl(InputEventAarAkt_V, EventAarSidst_DW))
DataBilletAkt_T <- DataBillet_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD) &
  grepl(BillettypeAkt_V, Billettype_DW))
DataPraemiePengeAkt_T <- DataPraemiePenge_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD) &
  grepl(BillettypeAkt_V, Billettype_DW))
DataPraemieYngstAeldstAkt_T <- DataPraemieYngstAeldst_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD))
...
DataDeltPuljerAkt_T <- DataDeltPuljer_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD) &
  grepl(BillettypeAkt_V, Billettype_DW))
DataDeltAndetAkt_T <- DataDeltAndet_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD))
DataDeltKlubAkt_T <- DataDeltKlub_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD) &
  grepl(BillettypeAkt_V, Billettype_DW))
DataDeltByAkt_T <- DataDeltBy_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD) &
  grepl(BillettypeAkt_V, Billettype_DW))
DataDeltAlderKatAkt_T <- DataDeltAlderKat_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD) &
  grepl(BillettypeAkt_V, Billettype_DW))
DataDeltKoenAkt_T <- DataDeltKoen_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD) &
  grepl(BillettypeAkt_V, Billettype_DW))
DataDeltGenTilAkt_T <- DataDeltGenTil_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD) &
  grepl(BillettypeAkt_V, Billettype_DW))
DataDeltOrdreKatAkt_T <- DataDeltOrdreKat_T %>% filter(
  grepl(InputEventAarAkt_V, EventAar_RD) &
  grepl(BillettypeAkt_V, Billettype_DW))
  ...
  DataDeltPuljerAkt_T %>%
    kbl(col.names = NA, align = "cclr", escape = F,
      caption = paste0(
        ...
        "<br>",
        "Rating er opdateret pr. ", DataEventAarAkt_T$EventAarRatingDato_RD_DMAA_DW, ".",
        "<br>",
        "<br>",
