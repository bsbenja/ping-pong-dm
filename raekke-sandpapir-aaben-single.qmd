...
#| label: fig-klubber
#| fig-cap: "Klubber."
#| fig-height: !expr (as.numeric(DataAkt_T %>% filter(!is.na(Delt_ID) & grepl("Tilmeldt", OrdreStatusSimpelKat_RD)) %>% summarise(length(unique(Klub_RD))))+1.5)/3.3
DataAkt_T %>%
	filter(!is.na(Delt_ID) & grepl("Tilmeldt", OrdreStatusSimpelKat_RD)) %>%
...
#| fig-height: 5
DataAkt_T %>%
  filter(!is.na(Delt_ID) & grepl("Tilmeldt", OrdreStatusSimpelKat_RD) & !grepl("Ingen klub|Udlandet", Klub_RD)) %>%
...
#| fig-height: !expr (as.numeric(DataAkt_T %>% filter(!is.na(Delt_ID) & grepl("Tilmeldt", OrdreStatusSimpelKat_RD)) %>% summarise(length(unique(DeltAlderKat_RD))))+1.5)/3.3
DataAkt_T %>%
	filter(!is.na(Delt_ID) & grepl("Tilmeldt", OrdreStatusSimpelKat_RD)) %>%
...
#| label: fig-koen
#| fig-cap: "Køn."
#| fig-height: !expr (as.numeric(DataAkt_T %>% filter(!is.na(Delt_ID) & grepl("Tilmeldt", OrdreStatusSimpelKat_RD)) %>% summarise(length(unique(DeltKoen_RD))))+1.5)/3.3
DataAkt_T %>%
	filter(!is.na(Delt_ID) & grepl("Tilmeldt", OrdreStatusSimpelKat_RD)) %>%
...
#| fig-height: !expr (as.numeric(DataAkt_T %>% filter(!is.na(Delt_ID) & grepl("Tilmeldt", OrdreStatusSimpelKat_RD)) %>% summarise(length(unique(DeltGen_DW))))+1.5)/3.3
DataAkt_T %>%
	filter(!is.na(Delt_ID) & grepl("Tilmeldt", OrdreStatusSimpelKat_RD)) %>%
...
#| label: fig-ordre-kat
#| fig-cap: "Ordretype."
#| fig-height: !expr (as.numeric(DataAkt_T %>% filter(!is.na(Delt_ID)) %>% summarise(length(unique(OrdreKat_DW))))+1.5)/3.3
DataAkt_T %>%
