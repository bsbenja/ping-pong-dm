...
subtitle: |
  <b style=font-size:140%>Ping Pong DM - Uofficiel hjemmeside</b><br><i style=font-size:80>Velkommen til den uofficielle hjemmeside for Danske Mesterskaber i Ping Pong. Ping Pong er bordtennis på <b><u>lige vilkår</u></b> med sandpapirsbat, som er <b><u>åben for ALLE</u></b> til en <b><u>overkommelig pris</u></b>. Se mere ved at navigere rundt her på hjemmesiden. Fra mobil gøres dette via topmenuen.</i>
editor_options: 
...
:::::: grid
::: {.g-col-12 .g-col-md-4}
#### `r tbl2_EventAarAkt_T$EventAar_ID`

`r tbl2_EventAarAkt_T$InfoForside_DW`
:::
...
-   `r paste(IkonLinkNy_V)` [**ICTTF**](https://icttf.co){target="_blank"}\
    *International Classic Table Tennis Federation (ICTTF) er det styrende organ for alle nationale Ping Pong medlemmer, hvis mission er at genintroducere det underholdende og gavnlige spil Ping Pong, også kendt som klassisk bordtennis, til det globale fællesskab.*\
    ![](filer/medie/billede/icttf.png){width="4em"}
:::
::::::
:::::::
...
`r tbl2_EventAarAkt_T$InfoFacebook_DW`
:::
