...
DataAkt_T <- Analyse_Ordre %>% filter(grepl(InputEventAarAkt_V, EventAar_RD))
...
data.frame(
	...
	"Type" = c(
		paste0("<a style=color:#000000;text-decoration:none href=indbydelse-tilmelding-2023.qmd#ping-pong", ">DM i Ping Pong ", DataEventAarAkt_T$EventAarStartDatoTid_DW, "</a>"),
    paste(
...
2.  `r paste0("[Ratingopdateringen i bordtennis](https://bordtennisportalen.dk/DBTU/Ranglister){target=_blank} pr. ", DataEventAarAkt_T$EventAarRatingDato_RD_DMAA_DW, ".")`
...
```{r}
#| output: asis
cat(paste0("![](filer/event/", egen_sti_fun(DataEventAarAkt_T$EventAar_RD), "/bat-bold.png){width=15em}"))
```
:::
:::::
...
#| output: asis
cat(paste0(
IkonOvernatning_V, " Se forslag til evt. overnatning under <q>Intro, tidsplan & praktisk</q> [<b>HER</b>](indbydelse-tilmelding-", DataEventAarAkt_T$EventAarStartDatoTid_DW, ".qmd#intro-tidsplan-praktisk)."))
```
:::
:::::
...
#| output: asis
cat(paste0(
"<div class=ticketbutler-iframe data-type=EVENT data-domain=billetfix.dk data-slug=dm-i-ping-pong-", DataEventAarAkt_T$EventAarStartDatoTid_DW, "></div><script type=text/javascript src=https://unpkg.com/@ticketbutler/event-embedder@latest/dist/index.js></script>"))
```
...
#| output: asis
cat(paste0(
"(Hvis indlejret tilmelding ikke virker, klik [<b>HER</b>](https://billetfix.dk/da/e/dm-i-ping-pong-", DataEventAarAkt_T$EventAarStartDatoTid_DW, "){target=_blank})"))
```
:::
