...
DataBilletKatAkt_T %>%
	...
	footnote(paste0(
    "Først til mølle-princip. Tilmeldingsfrist ", DataEventAarAkt_T$EventAarFristDato_DW_DMAA_DW, ".<br>",
...
data.frame(
  ...
  extra_css = "border-top:0.7px solid #808080;border-bottom:0.7px solid #808080") %>%
	column_spec(2:3, extra_css = "border-top:0.7px solid #808080")
```
:::
