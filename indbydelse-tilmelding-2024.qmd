...
DataResultSidsteEventAkt_T <- DataResultSidsteEvent_T %>%
  filter(
    EventAarSidst_DW == InputEventAarAkt_V
...
data.frame(
	...
	"Type" = c(
		paste0("<a style=color:#000000;text-decoration:none href=indbydelse-tilmelding-", DataEventAarAkt_T$EventAarStartDato_DW_Aar_DW, ".qmd#ping-pong", ">DM i Ping Pong ", DataEventAarAkt_T$EventAarStartDato_DW_Aar_DW, "</a>"),
    paste(
    ...
    paste0("<a style=color:#000000;text-decoration:none href=indbydelse-tilmelding-", DataEventAarAkt_T$EventAarStartDato_DW_Aar_DW, ".qmd#fest-om-aftenen>Fest om aftenen</a>")),
	check.names = F) %>%
	kbl(table.attr = "data-quarto-disable-processing=true",
