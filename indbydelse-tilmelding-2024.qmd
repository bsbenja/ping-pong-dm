...
DataResultSidsteEventAkt_T <- DataResultSidsteEvent_T %>% filter(
...
::: {.callout-tip .g-col-12 .g-col-md-12 style="font-style:italic"}
## Ping Pong regler
