...
#let _extensions(
  ...
  set page(
    ...
    fill: if not var_page.background.contains("billede") {rgb(var_page.background)},
    background: if var_page.background.contains("billede") {image(var_page.background, width: 100%)},
    footer: none,
  )
