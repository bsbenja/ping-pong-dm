...
#| output: asis
cat(paste0(
"<b>Tilmeldinger billettype</b>^[<b>Tilmeldinger billettype</b>: Tilmeldinger billettype opgøres efter antal tilmeldinger til eventet fordelt på billettype.]",
...
"<b>Deltagere klubtype</b>^[<b>Deltagere klubtype</b>: Deltagere klubtype opgøres efter antal tilmeldte deltagere til eventet fordelt på <q>klub</q>, <q>ingen klub</q> og <q>udlandet</q>. Procentsatserne viser fordelingen heraf.]",
...
DataDeltKlubAkt_T %>%
	...
	row_spec(which(grepl("Afbud", DataDeltKlubAkt_T$OrdreStatusSimpelKat_RD)),
					 strikeout = T, color = DataEventAarAkt_T$EventAarFarve1_RD) %>%
	column_spec(1:4, extra_css = "border-top:0.7px solid #808080;font-size:90%") %>%
	remove_column(5:6) %>%
