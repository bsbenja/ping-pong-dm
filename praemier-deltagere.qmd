...
DataDeltKlubAkt_T %>%
	...
	kable_classic(position = "l", full_width = F, html_font = "verdana") %>%
	row_spec(0, background = unique(DataEventAarAkt_T$EventAarFarve1_RD), color = "#FFFFFF") %>%
	row_spec(which(grepl("Afbud", DataDeltKlubAkt_T$OrdreStatusSimpel_RD)),
					 strikeout = T, color = unique(DataEventAarAkt_T$EventAarFarve1_RD)) %>%
...
DataDeltByAkt_T %>%
	...
	kable_classic(position = "l", full_width = F, html_font = "verdana") %>%
	row_spec(0, background = unique(DataEventAarAkt_T$EventAarFarve1_RD), color = "#FFFFFF") %>%
	row_spec(which(grepl("Afbud", DataDeltByAkt_T$OrdreStatusSimpel_RD)),
					 strikeout = T, color = unique(DataEventAarAkt_T$EventAarFarve1_RD)) %>%
	column_spec(1, width_min = "2em") %>%
	column_spec(1:3, extra_css = "border-top:0.7px solid #999999") %>%
	remove_column(4:5) %>%
...
DataDeltAlderKatAkt_T %>%
	...
	kable_classic(position = "l", full_width = F, html_font = "verdana") %>%
	row_spec(0, background = unique(DataEventAarAkt_T$EventAarFarve1_RD), color = "#FFFFFF") %>%
	row_spec(which(grepl("Afbud", DataDeltAlderKatAkt_T$OrdreStatusSimpel_RD)),
					 strikeout = T, color = unique(DataEventAarAkt_T$EventAarFarve1_RD)) %>%
	column_spec(1, width_min = "2em") %>%
	column_spec(1:3, extra_css = "border-top:0.7px solid #999999") %>%
	remove_column(4:5) %>%
...
DataDeltKoenAkt_T %>%
	...
	kable_classic(position = "l", full_width = F, html_font = "verdana") %>%
	row_spec(0, background = unique(DataEventAarAkt_T$EventAarFarve1_RD), color = "#FFFFFF") %>%
	row_spec(which(grepl("Afbud", DataDeltKoenAkt_T$OrdreStatusSimpel_RD)),
					 strikeout = T, color = unique(DataEventAarAkt_T$EventAarFarve1_RD)) %>%
	column_spec(1, width_min = "2em") %>%
...
DataDeltGenTilAkt_T %>%
	...
	kable_classic(position = "l", full_width = F, html_font = "verdana") %>%
	row_spec(0, background = unique(DataEventAarAkt_T$EventAarFarve1_RD), color = "#FFFFFF") %>%
	row_spec(which(grepl("Afbud", DataDeltGenTilAkt_T$OrdreStatusSimpel_RD)),
					 strikeout = T, color = unique(DataEventAarAkt_T$EventAarFarve1_RD)) %>%
	column_spec(1, width_min = "2em") %>%
	column_spec(1:3, extra_css = "border-top:0.7px solid #999999") %>%
	remove_column(4:5) %>%
...
DataDeltOrdreKatAkt_T %>%
	...
	kable_classic(position = "l", full_width = F, html_font = "verdana") %>%
	row_spec(0, background = unique(DataEventAarAkt_T$EventAarFarve1_RD), color = "#FFFFFF") %>%
	row_spec(which(grepl("Afbud", DataDeltOrdreKatAkt_T$OrdreStatusSimpel_RD)),
					 strikeout = T, color = unique(DataEventAarAkt_T$EventAarFarve1_RD)) %>%
	column_spec(1, width_min = "2em") %>%
